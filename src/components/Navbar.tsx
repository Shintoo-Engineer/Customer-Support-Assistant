...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const xpToNextLevel =
    userProfile?.xpToNextLevel ?? 1000;
  ...
  const notifications = [
    {
      ...
      desc: 'Expert Dispute: Corporate Account Lockout',
      time: '10m ago'
    },
    {
      id: '2',
      title: 'Streak Milestone!',
      desc: '6-day training streak achieved (+150 XP)',
      time: '2h ago'
    },
    {
      id: '3',
      title: 'KB Document Updated',
      desc: 'KB-101 Refund & Credit Policy Guidelines updated',
      time: '1d ago'
    }
  ];
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="font-bold tracking-tight text-sm sm:text-lg text-white truncate">
            ...
            <p className="text-[11px] sm:text-xs text-slate-400 hidden md:block">
              ...
              AI Support Simulation & Real-Time Coaching
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          <div className="hidden xl:flex items-center gap-1.5 bg-slate-800/80 px-2.5 py-1.5 rounded-lg border border-slate-700 text-xs">
            ...
            <select
              ...
              onChange={(e) =>
                onChangeCoachingLevel(
                  e.target.value as CoachingLevel
                )
              }
            ...
            >
              ...
              <option
                value="assessment"
                className="bg-slate-800 text-amber-300"
              >
                Assessment (Blind Test)
              </option>
                  ...
                  (lang) => (
                    ...
                    <button
                      ...
                      className={`w-full text-left px-3 py-1.5 text-xs flex items-center justify-between hover:bg-slate-700/60 ${
                        activeLanguage === lang
                          ? 'text-indigo-400 font-semibold bg-slate-700/40'
                          : 'text-slate-200'
                      }`}
                    >
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-amber-950/40 border border-amber-800/40 text-amber-300 text-xs font-semibold">
            ...
            <Flame
              className="w-3.5 h-3.5 text-amber-400 fill-amber-400 animate-bounce"
            />
